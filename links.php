...
<body id="wrap">
    ...
    <div id="content">
        ...
        <h1>Useful links</h1>
        <ul>
            <li><a href="http://sourceforge.net" target="_blank">SourceForge</a>
                - the world's largest open source repository.</li>
            <li><a href="http://www.asmcommunity.net/" target="_blank">ASM Community</a>
                - assembly language resource.</li>
            <li><a href="http://www.asmcommunity.net/projects/nasmx" target="_blank">The NASMX Project</a>
